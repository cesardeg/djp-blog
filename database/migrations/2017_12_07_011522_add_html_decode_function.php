...
class AddHtmlDecodeFunction extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $sql = "
            ...
            CREATE FUNCTION `html_decode`(X TEXT) RETURNS VARCHAR(TEXT) CHARSET latin1 DETERMINISTIC
            BEGIN
            ...
            CREATE FUNCTION `strip_tags`(str TEXT) RETURNS TEXT CHARSET latin1 DETERMINISTIC
            BEGIN
